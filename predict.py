...
if __name__ == '__main__':
    ...
    class_checkpoint=torch.load(args.class_checkpoint, map_location=torch.device('cpu'))
    ...
    if args.rank!=0:
        ...
        seg_checkpoint = torch.load(args.seg_checkpoint, map_location=torch.device('cpu'))
